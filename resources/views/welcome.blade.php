...
<head>
  ...
  <title>Administrasi Surat Online Desa Rumbio</title>
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <img src="assets/img/logo_DESA.png" alt="Logo Desa Rumbio" style="height: 60px; margin-right: 10px;">
        <h1 class="sitename">DESA RUMBIO</h1>
      </a>
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8"> 
            <h2>Desa Rumbio</h2>
            <p>Pelayanan Administrasi Surat Online</p>
